    ...
    for page in range(6):  # This will check pages 0 to 5
        ...
        try:
            ...
            if table:
                ...
                st.write(f"Found {len(rows)} circular items on page {page}")
                ...
                st.warning(f"No table found on page {page}")
