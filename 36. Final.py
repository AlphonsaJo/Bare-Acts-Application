...
def update_circulars():
                ...
                for row in rows:
                    ...
                    if len(cells) >= 3:
                        ...
                        if download_link:
                            ...
                            file_name = os.path.join(circulars_folder, f"{valid_filename[:100]}_{timestamp}.pdf")
    ...
    st.success(f" Downloaded {total_downloads} new circulars.")
